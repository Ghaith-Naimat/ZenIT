...
public sealed class ReportExporter
{
    ...
    {
        ["Device"] = ["DeviceName", "Username", "SerialNumber", "Manufacturer", "Model", "WindowsVersion", "WindowsBuildNumber", "LastRebootTime", "Uptime"],
        ...
        ["Security"] = ["KasperskyStatus", "WindowsFirewallStatus", "BitLockerStatus", "MdmJumpCloudStatus"],
        ["Windows Health"] = ["PendingRebootStatus", "PendingUpdatesSummary", "FailedServices", "CriticalEventsLast7Days"],
