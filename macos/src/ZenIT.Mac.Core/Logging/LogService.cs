...
{
    public static readonly string DefaultLogPath = ZenITPaths.LogPath;
    ...
    private IEnumerable<string> GetCandidateLogPaths()
    {
        ...
        var fallbackDirectory = Path.GetDirectoryName(FallbackLogPath) ?? ZenITPaths.LogsDirectory;
